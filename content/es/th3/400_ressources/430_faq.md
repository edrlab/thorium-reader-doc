...
<dt id="notes-export">Si vuelvo a una versión anterior de Thorium, ¿qué sucede con mis notas y anotaciones?</dt>
<dd>
<p>A partir de Thorium 3.4.0, las notas se almacenan exclusivamente en SQLite, lo que representa una evolución importante en cómo Thorium persiste sus anotaciones y marcadores. Este cambio garantiza mejor rendimiento y confiabilidad.</p>
...
<p>Para conservar sus notas y anotaciones antes de revertir:</p>
<ol>
  <li>Abra Thorium Reader</li>
  <li>Vaya a la vista Biblioteca</li>
  <li>Para cada libro con notas, ábralo y exporte sus anotaciones</li>
  <li>Use el botón <span class="ui_button">Exportar notas</span> para guardar sus anotaciones en un archivo</li>
