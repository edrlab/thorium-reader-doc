...
Les instances auto-construites stockent alternativement la publication dans un dossier publication-dev.
</dd>

<dt id="notes-export">Si je reviens à une version antérieure de Thorium, qu'advient-il de mes notes ?</dt>
<dd>
<p>À partir de Thorium 3.4.0, le stockage des notes a été modifié pour de meilleures performances et fiabilité, ce qui représente une évolution importante de la manière dont Thorium persiste vos surlignages et marque-pages.</p>

<p><strong>Important :</strong> Si vous prévoyez de revenir à une version antérieure de Thorium (comme 3.3.0 ou une version plus ancienne), toutes les notes que vous avez créées dans Thorium 3.4.0 ou version ultérieure <strong>ne seront pas accessibles</strong> dans la version antérieure, car elles utilisent un format de stockage différent.</p>

<p>Pour préserver vos notes, marque-pages et surlignages avant de revenir à une version antérieure :</p>
<ol>
  <li>Ouvrez Thorium Reader</li>
  <li>Allez à la vue Bibliothèque</li>
  <li>Pour chaque livre contenant des notes, ouvrez-le et exportez les</li>
  <li>Utilisez le bouton <span class="ui_button">Exporter les notes</span> pour enregistrer vos marque-pages et surlignages dans un fichier</li>
  <li>Ensuite, revenez à la version souhaitée</li>
</ol>

<p>Nous vous recommandons de rester sur la version 3.4.0 ou ultérieure pour bénéficier du meilleur stockage des notes et éviter les problèmes de compatibilité.</p>
</dd>
</dl>