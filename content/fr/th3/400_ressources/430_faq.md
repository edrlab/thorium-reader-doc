...
<dt id="notes-export">Si je reviens à une version antérieure de Thorium, qu'advient-il de mes notes et annotations ?</dt>
<dd>
<p>À partir de Thorium 3.4.0, les notes sont stockées exclusivement dans SQLite, ce qui représente une évolution importante de la manière dont Thorium persiste vos annotations et signets. Ce changement garantit une meilleure performance et fiabilité.</p>
...
<p>Pour préserver vos notes et annotations avant de revenir à une version antérieure :</p>
<ol>
  <li>Ouvrez Thorium Reader</li>
  <li>Allez à la vue Bibliothèque</li>
  <li>Pour chaque livre contenant des notes, ouvrez-le et exportez vos annotations</li>
  <li>Utilisez le bouton <span class="ui_button">Exporter les notes</span> pour enregistrer vos annotations dans un fichier</li>
