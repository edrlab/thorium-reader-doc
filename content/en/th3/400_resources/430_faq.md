...
<dt id="notes-export">If I downgrade Thorium to an older version, what happens to my notes and annotations?</dt>
<dd>
<p>As of Thorium 3.4.0, notes are stored exclusively in SQLite, which represents an important evolution in how Thorium persists your annotations and bookmarks. This change ensures better performance and reliability.</p>
...
<p>To preserve your notes and annotations before downgrading:</p>
<ol>
  <li>Open Thorium Reader</li>
  <li>Go to the Library view</li>
  <li>For each book with notes, open it and export your annotations</li>
  <li>Use the <span class="ui_button">Export notes</span> button to save your annotations to a file</li>
