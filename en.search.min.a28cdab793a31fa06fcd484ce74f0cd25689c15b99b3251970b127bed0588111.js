'use strict';(function(){const searchDataURL='/thorium-reader-doc/en.search-data.min.78609350a6a8c30f07e798bea9c4ac3ce19ab74c8b88c1498a7b5d6044e2adec.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
