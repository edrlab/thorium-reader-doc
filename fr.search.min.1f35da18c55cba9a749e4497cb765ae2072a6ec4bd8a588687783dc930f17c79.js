'use strict';(function(){const searchDataURL='/thorium-reader-doc/fr.search-data.min.0defb8ef1835678cc826245394ac3d57c75040f1795df58f8846d0140507b997.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
