'use strict';(function(){const searchDataURL='/thorium-reader-doc/fr.search-data.min.4bd046675f2a03d65670c750127d559d3ea7d233cfe80541f04c7854202a1ff4.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
