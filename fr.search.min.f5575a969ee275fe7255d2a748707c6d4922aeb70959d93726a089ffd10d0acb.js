'use strict';(function(){const searchDataURL='/thorium-reader-doc/fr.search-data.min.5d70eed8e351f060cc299a52862e29b63046776542bd39fcdfda6942eceac696.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
