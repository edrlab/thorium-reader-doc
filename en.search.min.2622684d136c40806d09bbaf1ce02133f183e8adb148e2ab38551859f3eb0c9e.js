'use strict';(function(){const searchDataURL='/thorium-reader-doc/en.search-data.min.64ed5757498293b035f8c4f5aa220dcd87dac6f5088b46978314b47e4be357b5.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
