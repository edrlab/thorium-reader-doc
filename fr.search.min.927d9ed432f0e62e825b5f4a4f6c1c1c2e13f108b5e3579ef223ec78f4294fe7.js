'use strict';(function(){const searchDataURL='/thorium-reader-doc/fr.search-data.min.c71cd6bb6527003e8de57b865aca3b373595abcfaa76a450f7063624a72e8f67.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
