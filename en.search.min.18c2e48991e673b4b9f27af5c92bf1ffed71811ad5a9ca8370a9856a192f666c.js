'use strict';(function(){const searchDataURL='/thorium-reader-doc/en.search-data.min.ac3b5349668c56ccbcff2e52367371094429faf9febfe31b85db295d5fe5948a.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
